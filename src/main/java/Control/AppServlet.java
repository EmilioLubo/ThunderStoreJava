...
public class AppServlet extends HttpServlet {
    ...
    private final String URI_EDIT = "WEB-INF/Pages/Productos/EditForm.jsp";
    private final String URI_REMOVE = "WEB-INF/Pages/Productos/DeleteForm.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(accion){
            case "add":
                p = new Producto();
                cargarProductoXParams(p, request);
                model.addProducto(p);
                break;
            case "update":
                id = Integer.parseInt(request.getParameter("id"));
    ...
    private void cargarProductoXParams(Producto p, HttpServletRequest request){
